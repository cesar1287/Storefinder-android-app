...
public class SettingsActivity extends PreferenceActivity {
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            ...
            bar = (AppBarLayout) LayoutInflater.from(this).inflate(comcom.projects.storefinder.R.layout.toolbar_settings, root, false);
            root.addView(bar, 0);
        } else {
            ...
            if (getTheme().resolveAttribute(comcom.projects.storefinder.R.attr.actionBarSize, tv, true)) {
    ...
    private void setupSimplePreferencesScreen() {
        addPreferencesFromResource(comcom.projects.storefinder.R.xml.preference_settings);
            ...
            if (preference instanceof ListPreference) {
                ...
                if(preference.getKey().compareTo("notifications_radius") == 0) {
                    String valStr = String.format("%s %s", stringValue,
                            MGUtilities.getStringFromResource(context, comcom.projects.storefinder.R.string.km));
                    ...
                    String maxTitle = String.format("%s (%s %.2f %s)",
                            MGUtilities.getStringFromResource(context, comcom.projects.storefinder.R.string.radius_nearby),
                            MGUtilities.getStringFromResource(context, comcom.projects.storefinder.R.string.max),
                            max,
                            MGUtilities.getStringFromResource(context, comcom.projects.storefinder.R.string.km));
